...
public class Report {
	...
	String carForClient = "SELECT coches.codcoche, coches.nombrech, coches.modelo, ventas.color "
		+ "FROM coches, ventas " + "WHERE ventas.codcoche = coches.codcoche " + "AND ventas.dni = ?";
	...
	while (rs.next()) {
		...
		System.out.println("-----> Car: " + subsearch.getInt(1) + " " + subsearch.getString(2) + " "
			+ subsearch.getString(3) + " " + subsearch.getString(4));
	    }
	}
    }
}
